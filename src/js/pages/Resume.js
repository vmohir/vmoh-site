		...
		this.state = {
			skillgroups: [
				...
				},
				{
					...
					skills: [{ name: 'NativeScript', percent: 60 }, { name: 'React Native', percent: 40 }],
				},
				{
					title: 'Wordpress developing',
					skills: [
						{ name: 'Theme developing', percent: 100 },
				...
				{
					title: 'Other skills',
					skills: [{ name: 'SEO', percent: 70 }, { name: 'Git', percent: 80 }],
				},
				{
					title: 'English',
			...
			education: [
				{
					...
					desc: "I've been studying computer engineering at University of Tehran since Sep 2015.",
				},
			],
			jobs: [
				{

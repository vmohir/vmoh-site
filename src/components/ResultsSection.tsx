...
export default function ResultsSection() {
  ...
  if (totals.length === 0) {
    return <p class={styles.emptyMessage}>Add people and items to see results</p>;
  }
        ...
        {totals.map(personTotal => (
          <div key={personTotal.personId} class={styles.personResult}>
            ...
            <div class={styles.breakdown}>
              ...
              <div class={`${styles.breakdownRow} ${styles.balance} ${
                personTotal.balance < 0 ? styles.overpaid :
                personTotal.balance > 0 ? styles.underpaid :
                styles.settled
              }`}>
